  ...
  return (
    <nav className="fixed top-0 left-0 right-0 bg-gray-800/80 backdrop-blur-sm py-4 px-6 z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="space-x-12 absolute left-1/2 -translate-x-1/2">
          <Link to="/" className="hover:text-blue-400 text-2xl font-medium" >Home</Link>
          <Link to="/dashboard" className="hover:text-blue-400 text-2xl font-medium">Dashboard</Link>
        </div>
        <div className="Login">
          {/* "Start Now" button */}
          <Link to="/start" className="bg-blue-500 text-white px-6 py-2 rounded-md hover:bg-blue-600 transition duration-300">
            Start Now
          </Link>
        </div>
      </div>
